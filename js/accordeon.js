...
function toggleItem() {
 ...
 function toggleList() {
     ...
     if (isExpanded) {
         ...
         programBtnImg.classList.remove("collapsebtn")
         programBtnText.textContent = "Дивитися всi вiдгуки"; 
     } else {
         programList.classList.add("collapse")
         this.classList.remove("expanded")
         programBtnImg.classList.add("collapsebtn")
         programBtnText.textContent = "Закрити відгуки";
     } }